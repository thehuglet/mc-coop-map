...
scoreboard objectives add coop.current_level.sword dummy
scoreboard objectives add coop.current_spec.sword dummy
...
scoreboard objectives add coop.tmp dummy
scoreboard objectives add coop.var dummy
scoreboard objectives add coop.dev.reload used:carrot_on_a_stick
